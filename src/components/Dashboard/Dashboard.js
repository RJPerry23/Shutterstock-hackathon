              ...
              <div className='dashboard'>
                <div className='dashboard__top'>
                  <h2
                    className={
                      this.state.animationClass === 'test'
                        ? 'dashboard__top--heading'
                        : 'dashboard__top--heading--alternate'
                    }
                  >
                    {this.props.match.params.page ? this.props.match.params.page : 'Overview'}
                  </h2>
                  <img src={Search} className='dashboard__top--icon' alt='search'></img>
                  <input type='text' className='dashboard__top--search' placeholder='Search...'></input>
                  <div className='dashboard__top--corner'>
                    <div className='dashboard__top--corner--icons'>
                      <img
                        src={this.state.animationClass === 'test' ? Notifications : NotificationsDark}
                        className='dashboard__top--corner--icons--notifications'
                        alt='notifications'
                      />
                      <img
                        src={this.state.animationClass === 'test' ? Share : ShareDark}
                        className='dashboard__top--corner--icons--share'
                        alt='share'
                      />
                      <img
                        src={this.state.animationClass === 'test' ? Menu : MenuDark}
                        className='dashboard__top--corner--icons--menu'
                        alt='menu'
                      />
                    </div>
